...
class Searchs extends Component{
  ...
  componentDidMount = () => {
    ...
    this.props.ListFrontLoadingLWorkOrder(this.props.data)
  }
  ...
  SearchTab = () => {
    ...
    this.props.ListFrontLoadingLWorkOrder(data)
  }
  // 重置
  reset = () => {
    this.props.SET_STATE({
...
const mapStateToProps = (state) => {
  const {data,Time,endTime,stateList,yewuList,loading} = state.beforeWork
  return {data,Time,endTime,stateList,yewuList,loading}
}
const mapDispatchToProps = (dispatch) => {
  const {SET_STATE,GetDicDataByCategoryCode,GetBasValueByBasCategoryNo,ListFrontLoadingLWorkOrder} = dispatch.beforeWork
  return {SET_STATE,GetDicDataByCategoryCode,GetBasValueByBasCategoryNo,ListFrontLoadingLWorkOrder}
}
