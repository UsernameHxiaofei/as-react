                 ...
                 <Form>
                  <Row>
                    ...
                    {getFieldDecorator('beizu', {
                      initialValue: this.props.addData.workLocationNo,
                      rules: [{
                    ...
                    {getFieldDecorator('ren', {
                      initialValue: this.props.addData.workLocationName,
                      rules: [{
                        required: true, message: '请输入班组名称!',
                      }],
                    })(
                      <Input placeholder='请输入班组名称' onChange={this.workLocationNameChange} />
                    )}
              </FormItem>
                    </Col>
                    ...
                    {getFieldDecorator('type', {
                      initialValue: this.props.addData.workLocationTypeNo,
                      rules: [{
...
const mapStateToProps = (state) => {
  const {ADDVisible,addData,workList,DELVisible,data} = state.stationManagement
  return {ADDVisible,addData,workList,DELVisible,data}
}
...
const DeleteModals = Form.create()(DeleteModal)
