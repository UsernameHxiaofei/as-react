const host = 'https://f2e-srp.prepub.miaomaicar.com/';
const formHost = 'https://47.110.147.127:8082/';

export const env = {
  HOST: host,
  LOGIN_HOST: `https://sso.prepub.miaomaicar.com/login.htm`,
  REDIRECTION_URL: {
  ...
  SERVER_URL: {
    baseUrl: 'https://vs-srp.prepub.souche.com/', // 整车
    platUrl: 'https://pb-srp.prepub.souche.com/', // 平台
    masUrl: 'https://md-srp.prepub.souche.com/', // 主数据
    cusUrl: 'https://cs-srp.prepub.souche.com/', // 客商
    balanceUrl: 'https://sc-srp.prepub.souche.com/', // 结算中心
    saleUrl: 'https://as-srp.prepub.souche.com/', // 售后
    filesUrl: 'https://10.255.254.54:11080/', // 音频下载
  },
};
